...
OVERVIEW
------------------------------------------------
This is a cross-platform .NET console application built with .NET 9.0.
...
6. Duplicate Message IDs:
    If duplicate message IDs are encountered for the same pipeline, the application will use the first occurrence and ignore subsequent ones.
...
LogProcessor.cs: Core logic for processing log files
LogMessage.cs:   Data model for log messages
EncodingType.cs: Enum for supported encoding

Unit Tests: LogProcessorTests.cs, contains unit tests for the LogProcessor class

ERROR HANDLING
------------------------------------------------
The application handles various error conditions:
- Missing input files
- Ill-formatted log entries
...
------------------------------------------------
Output Format for Multiple Chains:
